...
const CardTop100 = (
    ...
    return (
        <li className="flex flex-col justify-center last:mr-5 shadow-[0_4px_18px_-10px_#7e7e7e] rounded-lg min-w-60 sm:last:mr-0 lg:min-w-0 hover:scale-105 ease-in-out duration-200">
            <Link
            ...
            >
                <Image
                    ...
                    height={500}
                    quality={100}
                    className="w-full h-fit rounded-t-lg object-cover object-top"
                    loading="lazy"
                />
