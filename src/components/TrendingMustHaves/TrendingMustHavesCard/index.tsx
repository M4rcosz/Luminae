    ...
    return (
        <li className="last:mr-5 sm:last:mr-0 sm:flex sm:flex-col sm:flex-1 sm:min-w-full">
            ...
            <footer className="flex rounded-b-lg h-[92px] p-4 gap-3 items-center justify-between h-32 bg-[#262626] lg:h-fit lg:flex-col lg:items-start lg:p-5 ">
                ...
                <Link
                    href="#"
                    className="text-sm text-white border-[#D9D9D9] py-3 px-6 whitespace-nowrap border flex items-center rounded-lg h-fit md:text-base lg:self-end  hover:bg-[#ddd] hover:text-black hover:font-bold hover:border-[#ffffff0] ease-in-out duration-300"
                    role="button"
                >
