...
const MenuHamburguer = () => {
    ...
    return <>
        ...
        <div className={`${open ? "flex" : "hidden"} flex-col fixed top-0 left-0 w-screen bg-white z-50 `}>
            <div className="flex w-full items-center px-Mobile py-3">
                ...
                >
                    <path d="M28.4249 14.1004L13.5757 28.9497M28.4249 28.9496L13.5757 14.1003" stroke="#28303F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
